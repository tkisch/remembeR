...
Note: erster Versuch hat nicht funktioniert; nachdem pandoc (http://johnmacfarlane.net/pandoc/) installiert wurde, hat alles funktioniert, bis auf den Motionchart..check below for hints on macromedia security settings.
